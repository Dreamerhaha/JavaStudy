...
## 简述 volatile 关键字(或 volatile 的内存语义或 volatile 的 2 个特性)
...
## jvm模型跟jmm模型
jvm（java虚拟机）模型，jmm（java内存模型）
![在这里插入图片描述](https://img-blog.csdnimg.cn/20190630103219701.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzMwMzI1ODMz,size_16,color_FFFFFF,t_70)

## 锁的原理
参考：https://www.cnblogs.com/barrywxx/p/8678698.html

## 为何hashmap当链表长度为8时转化成红黑树
1. 因为红黑树的查找长度是log（n），当时8时链表查找长度是4，但是红黑树是3，当长度为6时，链表查找长度也是3因此以8作为临界点；
